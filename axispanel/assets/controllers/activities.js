    jQuery(document).ready(function() {
        ...
        //activity IMAGES SETTINGS / size in bit
            ...
            if (!$('#editForm').isValid(conf.language, conf, true)) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        toastr.success('Record updated successfully', 'Notification', {
                            timeOut: 5000
                        })
                    },
                    error: function(err) {
            ...
            if (!$('#newform').isValid(conf.language, conf, true)) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#newFormContainer').hide(700);
                        toastr.success('Record created successfully', 'Notification', {
                            timeOut: 5000
                        })
                    },
                    error: function(err) {
                ...
                submitButton.addEventListener("click", function() {
                    ...
                    if ($('#newform').isValid(conf.language, conf, true)) {
                        ...
                        $.ajax({
                            ...
                            toastr.success("Activity created successfully", 'Notification', {
                                timeOut: 5000
                            });
            ...
            $(document).on('confirmation', '.remodal', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        inst.close();
                        toastr.success('Record deleted successfully', 'Notification', {
                            timeOut: 5000
                        })
                    },
                    error: function(err) {
