    ...
    $('#datatable3 tbody').on( 'click', '#editRecord', function (event) {
       ...
       console.log(mainRecord)
        ...
        $('#editFormContainer').find('#author').val(mainRecord.author)
        $('#editFormContainer').find('#newsDate').val(mainRecord.newsDate)
        $('#editFormContainer').find('#text').val(mainRecord.text)
